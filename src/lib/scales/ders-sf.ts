...
export const dersSf: Scale = {
  ...
  nameEn: "DERS-SF Difficulties in Emotion Regulation Scale (Short Form)",
  description: "评估情绪策略、不接纳、冲动控制、觉察、清晰度等六个维度",
  descriptionEn: "Assesses six dimensions: strategies, non-acceptance, impulse control, awareness, clarity, goals",
  timeFrame: "通常情况下",

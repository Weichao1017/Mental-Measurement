...
export const ecr12: Scale = {
  ...
  nameEn: "ECR-12 Experiences in Close Relationships (Short)",
  description: "测量依恋焦虑（担心被抛弃）与依恋回避（不愿意亲密）两个维度",
  descriptionEn: "Measures attachment anxiety (fear of abandonment) and attachment avoidance (discomfort with closeness)",
  timeFrame: "通常情况下",

...
export const maia2: Scale = {
  ...
  slug: "maia2",
  name: "MAIA-2 内感受觉知量表",
  nameEn: "MAIA-2 Multidimensional Assessment of Interoceptive Awareness",
  description: "评估 8 个维度的身体觉察、注意调节、信任身体等能力",
  descriptionEn: "Assesses 8 dimensions of body awareness, attention regulation, and trust in body sensations",
  timeFrame: "通常情况下",

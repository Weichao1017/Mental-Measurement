...
export const mdq: Scale = {
  ...
  items: [
    ...
    },
    {
      ...
      textEn: "You were much more talkative or spoke faster than usual",
      options: YES_NO,
      sourceRef: "MDQ Q1.5",
    },
    {
    ...
    },
    {
      ...
      textEn: "You were much more social or outgoing than usual, for example, you telephoned friends in the middle of the night",
      options: YES_NO,
      sourceRef: "MDQ Q1.10",
    },
    {
    ...
    },
    {
      ...
      textEn: "You did things that were unusual for you or that other people might have thought were excessive, foolish, or risky",
      options: YES_NO,
      sourceRef: "MDQ Q1.12",
    },
    {
      ...
      dimension: "MD",
      text: "花钱使你自己或家人陷入麻烦",
      textEn: "Spending money got you or your family in trouble",
      options: YES_NO,
      sourceRef: "MDQ Q1.13",
    },
    {
      ...
      textEn: "If you checked YES to more than one of the above, have several of these ever happened during the same period of time?",
      options: YES_NO,
      sourceRef: "MDQ Q2",
    },
    {
  ...
  dimensions: [
    ...
    },
    {
      ...
      description: "标准要求：同时发生才算阳性（仅为判定条件，非症状严重度）",
      descriptionEn: "Required: symptoms must co-occur for positive screen (criterion, not severity)",
      itemIndices: [14],
      neutralValence: true,
    },
    {
      ...
      description: "标准要求：中度以上影响（≥ 2）（仅为判定条件，非症状严重度）",
      descriptionEn: "Required: moderate or higher impact (≥ 2) (criterion, not severity)",
      itemIndices: [15],
      neutralValence: true,
    },
  ],

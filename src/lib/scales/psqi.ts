...
export const psqi: Scale = {
  ...
  nameEn: "PSQI Pittsburgh Sleep Quality Index (Simplified)",
  description: "评估过去一个月的睡眠质量与睡眠相关问题（简化为 18 题 Likert）",
  descriptionEn: "Assesses sleep quality and related issues over the past month (simplified to 18 Likert items)",
  timeFrame: "过去一个月",
  timeFrameEn: "Past month",
  estimatedMinutes: 4,
  isCore: false,
  highIsBetter: false,

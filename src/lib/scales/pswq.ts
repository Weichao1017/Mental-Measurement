...
export const pswq: Scale = {
  ...
  instructionsEn:
    "Rate each statement on how typical it is of you. 1 = Not at all typical, 5 = Very typical. Answer honestly — there are no right or wrong answers.",
  options: [
    { value: 1, label: "完全不像我", labelEn: "Not at all typical", short: "完全不像", shortEn: "Not at all" },
    { value: 2, label: "不太像我", labelEn: "Slightly typical", short: "不太像", shortEn: "Slight" },
    { value: 3, label: "有些像我", labelEn: "Somewhat typical", short: "有些像", shortEn: "Somewhat" },
    { value: 4, label: "比较像我", labelEn: "Moderately typical", short: "比较像", shortEn: "Moderate" },
    { value: 5, label: "非常像我", labelEn: "Very typical", short: "非常像", shortEn: "Very" },
  ],
  items: [
    ...
    { index: 16, dimension: "WO", text: "对于即将到来的计划，我会担心", textEn: "I worry about projects until they are all done", sourceRef: "PSWQ #16" },
  ],
  dimensions: [
    {
      code: "WO",
